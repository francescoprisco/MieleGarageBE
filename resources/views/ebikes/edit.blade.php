                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="weight" class="form-control" name="weight" value="{{$ebike->weight}}" placeholder="Peso" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="battery">Velocità Massima</label>
                                                <input type="number" id="max_speed" class="form-control" name="max_speed" value="{{$ebike->max_speed}}" placeholder="Velocità Massima" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="battery">Cambio</label>
                                                <input type="number" id="gear" class="form-control" name="gear" value="{{$ebike->gear}}" placeholder="Cambio" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="battery">Tipo Telaio</label>
                                                <input type="number" id="frame" class="form-control" name="frame" value="{{$ebike->frame}}" placeholder="Tipo Telaio" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
